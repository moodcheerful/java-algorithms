...
import graphs.DepthFirstSearchNonRecursive;

import utils.Graph;

public class DepthFirstSearchNonRecursiveTest {
	
	public static final Logger logger = Logger.getLogger(DepthFirstSearchNonRecursiveTest.class);
	...
	public void testDFS() {
		...
		int s = 0;
		DepthFirstSearchNonRecursive dfs = new DepthFirstSearchNonRecursive(graph, s);
